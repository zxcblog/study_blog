...
func (c *userClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*UserAuthRes, error) {
	out := new(UserAuthRes)
...
func (c *userClient) Login(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*UserAuthRes, error) {
	out := new(UserAuthRes)
